...
Studies show that ${anxietyPercentage}% of users experience anxiety and 
${depressionPercentage}% experience depression due to social media pressure.`;
...
// Function to display a response based on selected mood
function checkMood() {
